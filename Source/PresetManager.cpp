...
{
    // All factory presets are declarative (see extendedPresetTable) so the
...
const std::vector<PresetManager::PresetData>& PresetManager::extendedPresetTable()
{
    static const std::vector<PresetData> table =
    {
        ...
        { "Init",
          {},
          { {"auto_enabled",0},{"dly_enabled",0} }, -1, {} },
        ...
        { "Warm Vocal",
          ...
          { {"sat_mode",0},{"auto_enabled",0},{"dly_enabled",0} }, -1, {} },
        ...
        { "Dreamy Ambience",
          { {"comp_threshold",-18.0f},{"comp_ratio",2.5f},{"comp_makeup",1.5f},
            ...
            {"verb_size",0.85f},{"verb_damping",0.2f},{"verb_width",1.0f},{"verb_mix",0.38f},
            {"dly_time",480.0f},{"dly_feedback",0.45f},{"dly_mix",0.24f} },
          { {"sat_mode",0},{"dly_pingpong",1},{"auto_enabled",0},{"deess_enabled",0} }, -1, {} },
        ...
        { "Podcast Voice",
          ...
          { {"auto_enabled",0},{"dly_enabled",0},{"verb_enabled",0} }, -1, {} },
        ...
        { "Stadium Anthem",
          { {"eq_band2_gain",2.5f},{"comp_threshold",-16.0f},{"comp_ratio",4.5f},{"comp_makeup",5.0f},
            {"verb_size",0.7f},{"verb_damping",0.3f},{"verb_width",1.0f},{"verb_mix",0.32f},
            {"dly_time",350.0f},{"dly_feedback",0.35f},{"dly_mix",0.18f} },
          {}, -1, {} },
        ...
        { "R&B Silk",
          { {"eq_band0_freq",120.0f},{"eq_band0_gain",1.5f},{"eq_band2_freq",2800.0f},{"eq_band2_gain",1.5f},
            ...
            {"verb_size",0.45f},{"verb_mix",0.2f} },
          {}, -1, {} },

        { "Silky R&B Runs",
          { {"auto_speed",0.1f},{"auto_amount",0.6f},{"comp_threshold",-22.0f},{"comp_ratio",2.5f},
            {"comp_attack",12.0f},{"comp_release",130.0f},
            {"verb_size",0.48f},{"verb_mix",0.22f} },
          {}, 0, {0,2,3,5,7,8,10} },
        ...
        { "Aggressive Rock Shout",
          ...
          { {"auto_enabled",0},{"verb_enabled",0} }, -1, {} },
        ...
        { "Telephone FX",
          ...
          { {"auto_enabled",0},{"verb_enabled",0},{"dly_enabled",0} }, -1, {} },

        { "Robot Voice",
          { {"auto_speed",0.0f},{"auto_amount",1.0f},{"auto_character",1.0f},{"auto_mix",1.0f} },
          { {"verb_enabled",0} }, 0, {0,2,4,6,8,10} },
        ...
        { "Ethereal Whisper",
          { {"eq_band0_freq",150.0f},{"eq_band0_gain",-4.0f},{"eq_band3_gain",2.0f},
            ...
            {"verb_size",0.92f},{"verb_damping",0.15f},{"verb_mix",0.48f} },
          { {"auto_enabled",0} }, -1, {} },

        { "Ambient Pad Vocal",
          { {"verb_size",0.95f},{"verb_damping",0.1f},{"verb_mix",0.55f},
            {"dly_time",600.0f},{"dly_feedback",0.55f},{"dly_mix",0.32f} },
          {}, -1, {} },
        ...
        { "Retro Disco",
          { {"eq_band2_gain",2.0f},{"comp_threshold",-18.0f},{"comp_ratio",3.5f},{"comp_attack",6.0f},
            {"comp_release",70.0f},{"comp_makeup",3.0f},
            {"verb_size",0.4f},{"verb_mix",0.16f},{"dly_time",220.0f},{"dly_feedback",0.32f},{"dly_mix",0.18f} },
          {}, -1, {} },

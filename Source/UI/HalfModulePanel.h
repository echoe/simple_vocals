...
/** Base class for a half module's control panel. Provides a consistent
...
class HalfModulePanel : public juce::Component,
                    private juce::Timer
{
public:
    HalfModulePanel (const juce::String& title, juce::Colour accent)
        : accentColour (accent), panelTitle (title)
    {
        startTimerHz (30);
    }

    ~HalfModulePanel() override { stopTimer(); }
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        // Border disabled when half module
    ...
    {
        return getLocalBounds().withTrimmedTop (24).reduced (6, 2);
    }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HalfModulePanel)
};
